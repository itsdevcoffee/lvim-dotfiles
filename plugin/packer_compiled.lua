...
_G.packer_plugins = {
  ...
  ["vim-smoothie"] = {
    loaded = true,
    path = "/home/texmex/.local/share/lunarvim/site/pack/packer/start/vim-smoothie",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'lsp_signature.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
